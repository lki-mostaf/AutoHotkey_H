...
void Object::CallMetaDelete()
{
	...
	ASSERT(mRefCount == 1 && (g->ExcptMode & EXCPTMODE_DELETE));
...
Object *Object::CreatePtrClass(Object *sc, Object *sp, StructInfo *spsi)
{
	...
	// ahk_h: No AddRef() in CreateClass
	// ptr_pro->Release();
	_freea(buf);
...
void Object::CreateRootPrototypes()
{
	...
	auto bif = new BuiltInFunc { _T(""), Any___Init, 1, 1 };
	sAnyPrototype->DefineMethod(_T("__Init"), bif);
	bif->Release();
	...
	DefineClasses(Object::sClass, Object::sPrototype, {
		...
		,{_T("Worker"), &Worker::sPrototype, NewObject<Worker>, Worker::sMembers}
	});
...
#ifdef ENABLE_DECIMAL
				{_T("Decimal"), &Decimal::sPrototype, {Decimal::Create, 2, 2}, Decimal::sMembers},
#endif // ENABLE_DECIMAL
	...
	// ahk_h: otherwise Struct.Array.Ptr will be leaked.
	CreatePtrClass(sCArrayClass, sCArrayPrototype, sCArrayPrototype->GetStructInfo(true))->Release();
...
thread_local Object *Object::sStructPrototype, *Object::sPtrPrototype, *Object::sCArrayPrototype;
